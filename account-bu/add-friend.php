<?php
  ...
  <h1>MY FRIEND</h1>
  <form action="add-friend.php" class="form-inline" method="get" style="margin-left: 610px;">
  <input type="text" class="form-control" name="keyword" placeholder="Search Contact" required/>

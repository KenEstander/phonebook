...
?>
  ...
  <tr>
    ...
    <td><?=$age?></td>
    <td><?=$row->birthday?></td>
    <td><a href="edit.php?Id=<?=$row->Id?>" class="btn btn-info">Edit</a>
      <a href="process.php?action=delete-contact&Id=<?=$row->Id?>" class="btn btn-danger">Delete</a> </td>
    </tr>
<?php endforeach; ?>
</table>
<a href="add.php" class="btn btn-primary" style="width:30%">ADD</a>
